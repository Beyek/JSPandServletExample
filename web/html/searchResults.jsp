...
<jsp:include page="header.jsp">
	<jsp:param name="prevPage" value="searchResults"/>
</jsp:include>
		...
		<div class="container">
			...
			<div class="people-cards">
				...
				<div class="person-card">
					...
					<p class="card-text">
						Jessica Newton-Smith joined us in 2012 and brings more than <em>10
							years</em> of financial management experience to H+ Sports, spanning a
						variety of companies and industries ranging from <em> Fortune
							500 agencies</em> to start-ups. She has extensive experience working
				...
				<div class="person-card">
					...
					<p class="card-text">
						Phi Tang joined H+ Sports in <em>2007</em> as Manager of Marketing
						...
						development, and implementation of the H+ Sport product lines.
				...
				<div class="person-card">
					...
					<p class="card-text">
						Maria Sontas has been with H+ Sport since 2010. She oversees the
						...
						campaigns, social media initiatives, and events are planned to <em>position
							the company</em> strongly in a competitive marketplace. Maria is a <em>competing
							triathlete</em> and her passion for our products shows in her unique
				...
				<div class="person-card">
					...
					<p class="card-text">
						Angela Hashton joined the company in 2009, to <em>initiate
							new relationships</em> for our growing line of H+ Sports active
						apparel. After being with the company for a year, she was promoted
						to Director of Sales. Angela is the drive behind the H+ Sport <em>ACTIVE
				...
				<div class="person-card">
					...
					<p class="card-text">
						Michael Lewiston is a multi-faceted <em>creative person</em> who
